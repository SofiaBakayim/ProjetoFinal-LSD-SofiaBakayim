<?php
// Configurar MySQL diretamente
error_reporting(E_ALL);
ini_set('display_errors', 1);

// Configurações
$host = '127.0.0.1'; // Usar IP em vez de localhost
$user = 'root';
$pass = '';
$dbname = 'chronos';
...
echo "<title>Configuração MySQL - Chronos</title>";
echo "<style>";
...
echo "<h1>🔧 Configuração MySQL - Sistema Chronos</h1>";
...
try {
    ...
    echo "<li><a href='login.php' class='btn'>🔐 Testar Login</a></li>";
    echo "<li><a href='perfil.php' class='btn'>👤 Ver Perfil</a></li>";
    ...
    echo "<li>Veja as informações completas para o professor</li>";
    echo "</ol>";
    echo "</div>";
