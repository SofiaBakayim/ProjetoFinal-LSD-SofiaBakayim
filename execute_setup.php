<?php
// Executar configuração da base de dados e mostrar informações
...
echo "<title>Configuração do Sistema Chronos</title>";
echo "<style>";
...
echo "<h1>🔧 Configuração do Sistema Chronos</h1>";
