...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (verify_user($email, $password)) {
        ...
        $login_error = 'Email ou password inválidos!';
    }
}
?>
<!DOCTYPE html>
...
<head>
    ...
    <style>
        ...
        .main-content {
            ...
            position: relative;
            padding-bottom: 60px;
            min-height: calc(100vh - 160px); /* header + rodapé */
        }
        .login-container {
        ...
        .login-form input:focus {
            border: 2px solid #E2BF5F;
            background: #fff;
            box-shadow: 0 0 10px rgba(226, 191, 95, 0.3);
        }
        ...
        .login-btn:hover {
            ...
            box-shadow: 0 4px 12px rgba(99, 1, 2, 0.3);
        }
        ...
        .google-btn:hover {
            ...
            border-color: #E2BF5F;
            transform: translateY(-2px);
            box-shadow: 0 4px 12px rgba(226, 191, 95, 0.3);
        }
        ...
        .back-link {
            ...
            border: 1px solid #855A25;
            transition: all 0.3s ease;
            box-shadow: 0 2px 8px rgba(99, 1, 2, 0.1);
        }
...
<body>
    ...
    <main class="main-content">
        <div class="login-container">
            ...
            <?php if (isset($login_error)): ?>
                <div style="color: #b30000; background: #fff3f3; border-radius: 12px; padding: 10px 18px; margin-bottom: 18px; font-weight: bold; text-align: center;">
                    <?php echo $login_error; ?>
                </div>
            <?php endif; ?>
            <div class="login-subtitle">Voltaste CHRONOS</div>
            
            <form class="login-form" autocomplete="off" id="loginForm" method="POST" action="/login">
                ...
                <?php if (isset($login_error)): ?>
                    <div class="error-message" style="display:block;"> <?= $login_error ?> </div>
                <?php endif; ?>
            ...
            <div class="login-footer">
                Não tem uma conta? <a href="registar.html">Torne-se um Chronos</a>
            </div>
        </div>
    </main>
    ...
    <div class="chro-btns-vertical-fixed">
        ...
        <button class="chro-btn" onclick="window.location.href='index.html'">Explore</button>
    </div>
